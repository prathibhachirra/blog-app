...
export const formCard =
  "bg-[#f5f5f7] rounded-2xl p-10 max-w-md mx-auto"
...
export const navLinkActiveClass =
  "text-[0.8rem] text-[#0066cc] font-medium"

// ─── Article / Blog ───────────────────────────────────
export const articleGrid =
  "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-[#e8e8ed] border border-[#e8e8ed] rounded-2xl overflow-hidden"
...
// //fetch
// //GET
//    let resObj=await fetch("",{method:"GET"}) //method is default for Get
//    if(res.status!==200)
//    {
...
// //axios
// //GET
//    let resOb=await axios.get("")//fetches and extracts the data
//    let res1=resOb.data 
//    //instead of checking extraction is done or not status code is 200 or not 
//    //here in axios ,no need to check

// //POST
//   let resOj=await axios.post("",obj)//no need to set content-type,no need of converting to json
//    let res2=resOj.data    
